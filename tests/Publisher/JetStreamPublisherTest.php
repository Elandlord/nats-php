...
it('publishes using stream->publish() for JetStream ack', function () {
    // Arrange
    $streamName = 'FLOW';
...
it('publishes fire-and-forget using stream->put()', function () {
    // Arrange
    $streamName = 'FLOW';
    $subject = 'flow.telemetry.heartbeat';
    $payload = 'fire-and-forget-payload';
    ...
    // Act
    $publisher = new JetStreamPublisher($connection, $streamName);
    $publisher->publishFireAndForget($subject, $payload);
